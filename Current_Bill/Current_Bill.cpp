...
int main(){
    ...
    /* 2-03-26*/    r1.pb(2448);  r2.pb(1730);  r3.pb(1134);  r4.pb(1789);   f.pb(3608); d_f.pb(2010);
    /* 1-04-26*/    r1.pb(2462);  r2.pb(1748);  r3.pb(1200);  r4.pb(1895);   f.pb(3608); d_f.pb(2220);
    /* 2-05-26*/    r1.pb(2489);  r2.pb(1773);  r3.pb(1285);  r4.pb(2001);   f.pb(3688); d_f.pb(2455);
    /* 1-06-26*/    r1.pb(2506);  r2.pb(1788);  r3.pb(1359);  r4.pb(2068);   f.pb(3755); d_f.pb(2695);
    /* 1-07-26*/    r1.pb(2530);  r2.pb(1802);  r3.pb(1438);  r4.pb(2161);   f.pb(3847); d_f.pb(2967);
